...
class CalculateQuarterlyPayments
{
    public static function execute(int $yearDuration, float $totalAmount, string $projectId)
    {
        ...
        // 3. Get the current date, move to the NEXT quarter of Next Year, and set to the start of that quarter
        $currentDate = Carbon::now()->addYear()->addQuarter()->startOfQuarter();
