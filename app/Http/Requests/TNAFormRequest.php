...
class TNAFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'officeTelNo' => 'nullable|string|max:50',
            'officeFaxNo' => 'nullable|string|max:50',
            'officeEmailAddress' => 'nullable|email|max:255',
            'factory_address' => 'nullable|string|max:500',
            'factoryTelNo' => 'nullable|string|max:50',
            ...
            'initial_capitalization' => 'nullable|numeric',
