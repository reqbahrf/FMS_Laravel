...
class ProjectProposalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'project_cost' => 'nullable|string|regex:/^\d{1,3}(,\d{3})*(\.\d{1,2})?$/',
            'amount_requested' => 'nullable|string|regex:/^\d{1,3}(,\d{3})*(\.\d{1,2})?$/',
