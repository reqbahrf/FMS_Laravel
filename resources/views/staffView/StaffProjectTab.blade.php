    ...
    <script type="module">
        $(document).ready(function() {
            ...
            $('#ApprovedtableBody').on('click', '.approvedProjectInfo', function() {
                ...
                $('#Amount').val(
                    parseFloat(inputs.filter('.fund_amount').val().replace(/,/g, '')).toLocaleString(
                        'en-US', {
                ...
                $('#building').val(parseFloat(inputs.filter('.building_Assets').val().replace(/,/g, ''))
                    .toLocaleString('en-US', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));
                $('#equipment').val(parseFloat(inputs.filter('.equipment_Assets').val().replace(/,/g, ''))
                    .toLocaleString('en-US', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));
                $('#workingCapital').val(parseFloat(inputs.filter('.working_capital_Assets').val().replace(
