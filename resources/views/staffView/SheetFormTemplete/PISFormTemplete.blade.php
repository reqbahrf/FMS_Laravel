                             ...
                             <form id="projectInfoForm">
                                 <div class="row gy-2">
                                     ...
                                     <div class="col-12 col-md-3">
                                         ...
                                         <input type="text" class="bottom_border" id="workingCapital"
                                             name="workingCapital">
                                     </div>
                                     <div class="col-12  mt-3">
                                         <h6>
                                     ...
                                     <div class="col-12 col-md-3">
                                         ...
                                         <input type="text" class="bottom_border" id="Regular_male"
                                             name="Regular_male">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="femaleInput" class="form-label">Female</label>
                                         <input type="text" class="bottom_border" id="Regular_female"
                                             name="Regular_female">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="subtotalInput" class="form-label">Sub-total</label>
                                         <input type="text" class="bottom_border" id="Regular_subtotal"
                                     ...
                                     <div class="col-12 col-md-3">
                                         <label for="maleInput" class="form-label">Male</label>
                                         <input type="text" class="bottom_border" id="Parttime_male"
                                             name="Parttime_male">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="femaleInput" class="form-label">Female</label>
                                         <input type="text" class="bottom_border" id="Parttime_female"
                                             name="Parttime_female">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="subtotalInput" class="form-label">Sub-total</label>
                                         <input type="text" class="bottom_border" id="Parttime_subtotal"
                                     ...
                                     <div class="col-12 col-md-3">
                                         <label for="maleInput" class="form-label">Male</label>
                                         <input type="text" class="bottom_border" id="Regu_Subcont_male"
                                             name="Regu_Subcont_male">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="femaleInput" class="form-label">Female</label>
                                         <input type="text" class="bottom_border" id="Regu_Subcont_female"
                                             name="Regu_Subcont_female">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="subtotalInput" class="form-label">Sub-total</label>
                                         <input type="text" class="bottom_border" id="Regu_Subcont_subtotal"
                                     ...
                                     <div class="col-12 col-md-3">
                                         <label for="maleInput" class="form-label">Male</label>
                                         <input type="text" class="bottom_border" id="Subcont_Parttime_male"
                                             name="Subcont_Parttime_male">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="femaleInput" class="form-label">Female</label>
                                         <input type="text" class="bottom_border" id="Subcont_Parttime_female"
                                             name="Subcont_Parttime_female">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="subtotalInput" class="form-label">Sub-total</label>
                                         <input type="text" class="bottom_border" id="Subcont_Parttime_subtotal"
                                     ...
                                     <div class="col-12 col-md-3">
                                         <label for="maleInput" class="form-label">Male</label>
                                         <input type="text" class="bottom_border" id="Indirect_Regular_male"
                                             name="Indirect_Regular_male">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="femaleInput" class="form-label">Female</label>
                                         <input type="text" class="bottom_border" id="Indirect_Regular_female"
                                             name="Indirect_Regular_female">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="subtotalInput" class="form-label">Sub-total</label>
                                         <input type="text" class="bottom_border" id="Indirect_Regular_subtotal"
                                     ...
                                     <div class="col-12 col-md-3">
                                         <label for="maleInput" class="form-label">Male</label>
                                         <input type="text" class="bottom_border" id="Indirect_Parttime_male"
                                             name="Indirect_Parttime_male">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="femaleInput" class="form-label">Female</label>
                                         <input type="text" class="bottom_border" id="Indirect_Parttime_female"
                                             name="Indirect_Parttime_female">
                                     </div>
                                     <div class="col-12 col-md-3">
                                         <label for="subtotalInput" class="form-label">Sub-total</label>
                                         <input type="text" class="bottom_border" id="Indirect_Parttime_subtotal"
