                    ...
                    <div class="row text-center gap-3">
                        ...
                        <div class="col-12">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"
                                id="Ai-Email-Generator-Spark--Streamline-Core" height="100" width="100">
                                ...
                                <g id="ai-email-generator-spark--mail-envelope-inbox-artificial-intelligence-ai">
                                    <path id="Subtract" fill="#97dde6" fill-rule="evenodd"
                                    ...
                                    <path id="Intersect" fill="#318791" fill-rule="evenodd"
                                        ...
                                        clip-rule="evenodd" stroke-width="1"></path>
                                    <path id="Union" fill="#318791" fill-rule="evenodd"
                        ...
                        @endif
                        <div class="col-12">
                            <form method="POST" onsubmit="showSpinner()" action="{{ route('verification.send') }}">
                                @csrf
