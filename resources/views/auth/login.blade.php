                ...
                <div class="row justify-content-center">
                            ...
                            <a href="index.php">
                                <span>
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        height="75.079px" viewBox="0 0 74.488 75.079"
                                        enable-background="new 0 0 74.488 75.079" xml:space="preserve">
                                        <g>
                    ...
                    <div class="row mt-3 z-3">
                        <div class="col-12 text-center">
                            <p class="">Don't have an account? <a href="signup.php" class="ms-1"><b>Sign
                                        Up</b></a></p>
                        </div> <!-- end col -->
                    </div>
