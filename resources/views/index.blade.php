...
<html lang="en" data-bs-theme="light">
    ...
    <body>
        <x-header />
        <section id="hero" class="d-flex flex-column justify-content-center align-items-center" style=" background-image: url({{ asset('hero.jpg') }});">
            ...
            <div class="container">
                ...
                <div class="row mb-3">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="icon-box">
                            <div class="icon">
                                <svg width="64px" height="64px" viewBox="-16 -16 96.00 96.00" data-name="Layer 1"
                                    id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">
                                        <rect x="-16" y="-16" width="96.00" height="96.00" rx="48"
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                        <div class="icon-box">
                            <div class="icon"><svg viewBox="-8.32 -8.32 80.64 80.64"
                                    xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#follow-up_req"
                                        aria-expanded="true" aria-controls="follow-up_req">
            ...
            <div class="container">
                ...
                <div class="benefit-item row align-items-center mb-5">
                    ...
                    <div class="col-md-7 text-center">
                        <img src="{{ asset('sampleProfile/tempImage.jpg') }}" class="img-fluid benefit-image"
                            alt="SETUP LOGO">
                    </div>
                </div>
                ...
                <div class="benefit-item row align-items-center mb-5">
                    <div class="col-md-7 text-center">
                        <img src="{{ asset('index_image/Provision of seed funds for technology acquisition and equipment upgrading..webp') }}"
                            class="img-fluid benefit-image" alt="technology acquisition">
                    </div>
                    <div class="col-md-5">
                        <div class="benefit-content">
                ...
                <div class="benefit-item row align-items-center mb-5">
                    ...
                    <div class="col-md-7 text-center">
                        <img src="{{ asset('index_image/Technical trainings.webp') }}" class="img-fluid benefit-image"
                ...
                <div class="benefit-item row align-items-center mb-5">
                    <div class="col-md-7 text-center">
                        <img src="{{ asset('index_image/Technical Advisory and Consultancy Services.webp') }}"
                            class="img-fluid benefit-image" alt="Technical Advisory and Consultancy Services">
                    </div>
                    <div class="col-md-5">
                        <div class="benefit-content">
                ...
                <div class="benefit-item row align-items-center mb-5">
                    ...
                    <div class="col-md-7 text-center">
                        <img src="{{ asset('index_image/Design of functional packages and labels.webp') }}"
                            class="img-fluid benefit-image" alt="Design of functional packages and labels">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="imgs-container row g-4">
                    <div class="col-md-4">
                        <div class="img-box h-100 d-flex flex-column">
                            <div class="sector-image">
                                <img src="{{ asset('sectors/primarySector.jpg') }}" class="img-fluid w-100"
                                    alt="Primary Sector">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="img-box h-100 d-flex flex-column">
                            <div class="sector-image">
                                <img src="{{ asset('sectors/secondarySector.jpg') }}" class="img-fluid w-100"
                    ...
                    <div class="col-md-4">
                        <div class="img-box h-100 d-flex flex-column">
                            <div class="sector-image">
                                <img src="{{ asset('sectors/TertiarySector.jpg') }}" class="img-fluid w-100"
                                    alt="Tertiary Sector">
                            </div>
                            <div class="imgbox-content flex-grow-1 d-flex flex-column">
