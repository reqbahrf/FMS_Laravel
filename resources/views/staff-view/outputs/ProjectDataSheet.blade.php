        ...
        >
            ...
            <tr>
                ...
                <td colspan="3">
                    <label><input
                            type="checkbox"
                            @if ($reportingQuarter == 'Q1') checked="checked" @endif
                        > 1st
                        Quarter </label>
                    &nbsp;&nbsp;
                    <label><input
                            type="checkbox"
                            @if ($reportingQuarter == 'Q2') checked="checked" @endif
                        > 2nd
                        Quarter </label>
                    &nbsp;&nbsp;
                    <label><input
                            type="checkbox"
                            @if ($reportingQuarter == 'Q3') checked="checked" @endif
                        > 3rd
                        Quarter </label>
                    &nbsp;&nbsp;
                    <label><input
                            type="checkbox"
                            @if ($reportingQuarter == 'Q4') checked="checked" @endif
                        > 4th
                        Quarter </label>
                </td>
            </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    >
                        <label><input
                                type="checkbox"
                                @if ($EnterpriseClass == 'Micro') checked="checked" @endif
                            >
                            Micro(assets&nbsp;&nbsp;&nbsp;Less than 3M)</label>
                        <label><input
                                type="checkbox"
                                @if ($EnterpriseClass == 'Small') checked="checked" @endif
                            >
                            Small(assets&nbsp;&nbsp;&nbsp;of 3M to 15M)</label>
                        <label><input
                                type="checkbox"
                                @if ($EnterpriseClass == 'Medium') checked="checked" @endif
                            >
                ...
                <tr>
                    ...
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    >{{ $DireRegularTotalWorkday }} <br></td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    >{{ $DireRegularTotalManMonth }} <br> </td>
                    <td
                        class="tg-8d8j"
                        colspan="3"
                    >{{ $RemarkDirectLabor }} <br> </td>
                </tr>
                <tr>
                    ...
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > <br>{{ $ParttimeTotalWorkday }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > <br>{{ $ParttimeTotalManMonth }} </td>
                    <td
                        class="tg-8d8j"
                        colspan="3"
                    > <br>{{ $RemarkParttime }} </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > <br>{{ $IndiRegularTotalWorkday }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > <br> {{ $IndiRegularTotalManMonth }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="3"
                    > <br> {{ $IndiRegularRemark }}</td>
                </tr>
                <tr>
                    ...
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > <br>{{ $IndiParttimeTotalWorkday }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > <br> {{ $IndiParttimeTotalManMonth }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="3"
                    > <br> {{ $IndiParttimeRemark }}</td>
                </tr>
                <tr>
                    <td
                        class="tg-0lax"
                    ...
                    <td
                        class="tg-cly1"
                        colspan="3"
                    >No. of Personnel: {{ $TotalEmployment }}</td>
                    <td
                        class="tg-cly1"
                        colspan="4"
                    >No. of Man-Months: {{ $TotalManMonth }}</td>
                </tr>
                <tr>
                    <td
                ...
                @foreach ($exportProduct as $index => $product)
                    <tr>
                        ...
                        <td
                            class="tg-8d8j"
                            colspan="2"
                        >{{ '₱ ' . $product['grossSales'] }}</td>
                        <td
                            class="tg-8d8j"
                            colspan="2"
                        >{{ '₱ ' . $product['productionCost'] }}</td>
                        <td
                            class="tg-8d8j"
                            colspan="2"
                        >{{ '₱ ' . $product['netSales'] }}</td>
                ...
                <tr>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    >{{ $CurrentgrossSales }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    >{{ $PreviousgrossSales }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    >{{ $TotalgrossSales }}</td>
                ...
                <tr>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    >{{ $CurrentEmployment }}</td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > {{ $PreviousEmployment }} </td>
                    <td
                        class="tg-8d8j"
                        colspan="2"
                    > {{ $TotalEmploymentGenerated }}</td>
                </tr>
                <tr>
                    <td
                        class="tg-8d8j"
