                    ...
                    <div class="w-75">
                        <div class="col-12 p-md-3 p-2">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('userName1') is-invalid @enderror" id="userName1" name="userName1" placeholder="Username" value="{{ old('userName1') }}">
                        ...
                        <div class="col-12 p-md-3 p-2">
                            <div class="form-floating">
                                <input type="password" id="password1" name="password1" class="form-control @error('password1') is-invalid @enderror" placeholder="Password">
                        ...
                        <div class="text-center">
                            <a href="{{ url('/') }}" class="text-decoration-none text-reset text-primary">home</a>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <script>
    $(document).ready(function() {
        ...
        $('#signup-form').on('submit', function(e) {
            ...
            var fieldsToValidate = ['userName1', 'password1', 'confirm1'];
            ...
            fieldsToValidate.forEach(function(fieldId) {
                ...
                if (field.val() === '') {
                    isValid = false;
                    field.addClass('is-invalid'); // add 'is-invalid' class to show validation feedback
                    console.log('Field ' + fieldId + ' is empty');
                } else {
                    field.removeClass('is-invalid'); // remove 'is-invalid' class if the field is valid
