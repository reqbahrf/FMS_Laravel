                            ...
                            <div class="row ms-md-4 ms-sm-2 my-4">
                                <div class="col-12 my-3">
                                    ...
                                    >
                                        ...
                                        Kindly provide the current assets for the building, equipment, and working
                                        capital for the current quarter.
                                    </div>
                                </div>
                                        ...
                                        <div class="col-12 col-md-8">
                                            ...
                                            >
                                                ...
                                                <p>Direct personnel are those who are actively involved in the
                                                    ...
                                                    <br>
                                                <ul>
                                                    <li>Please provide the number of regular and part-time direct
                                                        employees for both male and female.</li>
                                                    <li>Please also provide the total number of workdays for this
                                                        quarter.</li>
                                                </ul>
                                                </p>
                                                <hr>
                                        ...
                                        <div class="col-12 col-md-8">
                                            ...
                                            >
                                                ...
                                                <p>Indirect personnel are those who are not actively involved in
                                                    ...
                                                    <br>
                                                <ul>
                                                    <li>Please provide the number of regular and part-time indirect
                                                        employees for both male and female.</li>
                                                    <li>Please also provide the total number of workdays for this
                                                        quarter.</li>
                                                </ul>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    >
                                        ...
                                        <p>Please provide the necesary product Infomarmation for this Export and Local
                                            Market. The following are required Information for the product:
                                            <br>
                                        <ul>
                                            <li>Product Name</li>
                                        ...
                                        <hr>
                                        <p class="mb-0 text-secondary text-small">You may enter none on the product
                                            name if
                                            not applicable.
                                        </p>
                                    </div>
                                ...
                                <div class="col-12 my-3">
                                    ...
                                    >
                                        ...
                                        <p>
                                            ...
                                            Outlet. The following details are needed.
                                        <ul>
                                            <li>
                                                Export - location name in which the outlet is located(example: USA,
                                                China, etc)
                                            </li>
                                            <li>
                                                Local - location name in which the outlet is located(example: Carmin,
                                                Tagum, etc)
                                            </li>
                                        </ul>
                                        </p>
                                        <hr>
                                        <p class="mb-0 text-secondary text-small">You may enter none or leave blank if
                                            not applicable.
                                        </p>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <p class="paragraph-content">The Department of Science and Technology XI respect your privacy
                ...
                <div class="card">
                    ...
                    <div class="card-body text-justify">
                        <p class="paragraph-content">Welcome to DOST-SETUP-SYS. By accessing and using this website,
                            you agree to comply with and be bound by the following terms and conditions:
                        </p>
                        <p class="paragraph-content">
                            <strong>Acceptance of Terms:</strong> By using this website, you acknowledge that you have
                            read, understood, and agree to be bound by these terms and conditions
                        </p>
                        <p>
                            <strong>Use of the Website:</strong> You agree to use this website only for lawful purposes
                        ...
                        <p class="paragraph-content">
                            <strong>Changes to Terms:</strong> We reserve the right to modify these terms and conditions
                            at any time. Your continued use of the website after any changes indicates your acceptance
                            of the new terms.
                        </p>
                        <p class="paragraph-content">
                            <strong>Governing Law:</strong> These terms and conditions are governed by and construed in
