...
<body lang="en-PH" link="#000080" vlink="#800000" dir="ltr">
    ...
    <table autosize="1" cellpadding="7" cellspacing="0" style=" page-break-inside: avoid;">
        <colgroup>
            <col width="18">
            <col width="146">
            <col width="4">
    ...
    <table autosize="1" cellpadding="7" cellspacing="0"
        ...
        <tbody>
            ...
            @forelse ($ExpectedAndActualData as $row)
                <tr valign="top">
                    ...
                    <td width="196" style="border-right: 1px solid #000000 ; font-family: arial; font-size: 10pt">
                ...
                <td width="24" valign="top" style="border: 1px solid #000000; padding: 0cm 0.19cm">
                    <p align="center" style="orphans: 2; widows: 2">
                        <font face="Aptos, sans-serif">
                            <font size="3" style="font-size: 12pt">
                                <font face="Arial, sans-serif">
                                    <font size="2" style="font-size: 10pt">{{ $row['Approved_qty'] ?? '' }}</font>
                                </font>
                            </font>
                        </font>
                    </p>
                ...
                <td width="82" valign="top" style="border: 1px solid #000000; padding: 0cm 0.19cm">
                    <p align="right" style="orphans: 2; widows: 2">
                        <font face="Aptos, sans-serif">
                            <font size="3" style="font-size: 12pt">
                                <font face="Arial, sans-serif">
                                    <font size="2" style="font-size: 10pt">{{ $row['Approved_cost'] ?? '' }}</font>
                                </font>
                            </font>
                        </font>
                    </p>
                ...
                <td width="28" valign="top" style="border: 1px solid #000000; padding: 0cm 0.19cm">
                    <p align="center" style="orphans: 2; widows: 2">
                        <font face="Aptos, sans-serif">
                            <font size="3" style="font-size: 12pt">
                                <font face="Arial, sans-serif">
                                    <font size="2" style="font-size: 10pt">{{  $row['Actual_qty'] ?? '' }}</font>
                                </font>
                            </font>
                        </font>
                    </p>
                ...
                <td width="82" valign="top" style="border: 1px solid #000000; padding: 0cm 0.19cm">
                    <p align="right" style="orphans: 2; widows: 2">
                        <font face="Aptos, sans-serif">
                            <font size="3" style="font-size: 12pt">
                                <font face="Arial, sans-serif">
                                    <font size="2" style="font-size: 10pt">{{ $row['Actual_cost'] ?? '' }}</font>
                                </font>
                            </font>
                        </font>
                    </p>
                ...
                <td width="88" style="border: 1px solid #000000; padding: 0cm 0.19cm">
                    <p align="center" style="orphans: 2; widows: 2">
                        <font face="Aptos, sans-serif">
                            <font size="3" style="font-size: 12pt">
                                <font face="Arial, sans-serif">
                                    <font size="2" style="font-size: 10pt">{{ $row['acknowledgement'] ?? '' }}</font>
                                </font>
                            </font>
                        </font>
                    </p>
    ...
    <table width="751" cellpadding="7" cellspacing="0" style=" page-break-inside: avoid;">
        ...
        <tbody>
            ...
            <tr valign="top">
                <td width="209"
                    style="border-top: 1px solid #000000; border-bottom: none; border-left: none; border-right: none; padding: 0cm">
                    <p align="left" style="orphans: 2; widows: 2">
                        <font face="Aptos, sans-serif">
                            <font size="3" style="font-size: 12pt">
                                <font face="Arial, sans-serif">
